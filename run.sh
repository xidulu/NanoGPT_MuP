...
for lr in 1.28e-3 2.56e-3 5.12e-3 1.024e-2 2.048e-2 4.096e-2 8.192e-2 1.6384e-1 3.2768e-1 6.5536e-1 1.31072e0
...
# max_iters=18000
max_iters=18000
# lbatch comes from Laurence's script : )
lbatch -g 1 -t 24 \
    -q gpu --name owt_wd_$lr \
